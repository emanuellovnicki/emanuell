...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get(".../lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: ".../basicBot.js",
        cmdLink: ".../lovneofficial.eu",
        chatLink: ".../lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: ".../blacklists/ExampleNSFWlist.json",
                OP: ".../blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
